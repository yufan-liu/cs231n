...
class ThreeLayerConvNet(object):
    ...
    def __init__(self, input_dim=(3, 32, 32), num_filters=32, filter_size=7,
        ...
        self.params['W2'] = weight_scale * np.random.randn(F*H_new/2*W_new/2, hidden_dim)
    ...
    def loss(self, X, y=None):
        ...
        dx_a, dw_a, db_a = affine_backward(dx, a_cache)
        dx_ar, dw_ar, db_ar = affine_relu_backward(dx_a, ar_cache)
        dx_crp, dw_crp, db_crp = conv_relu_pool_backward(dx_ar, crp_cache)
        ############################################################################
        #                             END OF YOUR CODE                             #
        ############################################################################
        reg, W1, W2, W3 = self.reg, self.params['W1'], self.params['W2'], self.params['W3']
        grads['W1'] = dw_crp + reg * W1
        grads['b1'] = db_crp
        grads['W2'] = dw_ar + reg * W2
        grads['b2'] = db_ar
        grads['W3'] = dw_a + reg * W3
        grads['b3'] = db_a
